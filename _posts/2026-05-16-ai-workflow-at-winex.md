---
layout: post
title: "AI 落地工作流：WiNEX 实施团队的个人+项目共 6 个实战场景"
categories: [Work, AI]
description: 详细介绍 WiNEX 实施团队如何用 AI 处理工时填报、微信群消息、知识库检索、日志分析、SOP 测试、接口分析，覆盖完整工作流。
keywords: AI工作流, WiNEX, 企微机器人, 日志分析, SOP测试, 接口分析, 降本增效, 工时管理
author: 牛马便利店一号店员
mermaid: true
sequence: false
flow: false
...
目前各场景还是**分散的点**，下一步我们将把它们串联成一个**完整的 AI 工作流**：
